...
namespace C_GUI.QLForm
{
    public partial class FormChieuCaoDeGiay : Form
    {
        ...
        public void LoadData()
        {
            ...
            foreach (var a in _iQLChieuCaoDeGiay.GetAllView())
            {
                dgrid_show.Rows.Add(stt++, a.ChieuCaoDeGiay.Id, a.ChieuCaoDeGiay.MaKichCo, a.ChieuCaoDeGiay.KichCo, a.ChieuCaoDeGiay.TrangThai == 1 ? "hoat dong" : "khong hoat dong");
            }
        ...
        {
            _iQLChieuCaoDeGiay.Add(GetCtrlValues());
            LoadData();
        }
