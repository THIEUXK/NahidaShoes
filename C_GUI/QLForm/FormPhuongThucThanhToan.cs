...
namespace C_GUI.QLForm
{
    public partial class FormPhuongThucThanhToan : Form
    {
        ...
        public void LoadData()
        {
            ...
            foreach (PhuongThucThanhToan a in _IQlPhuongThucThanhToan.GetAll())
            {
                _ = dgrid_show.Rows.Add(stt++, a.Id, a.MaPhuongThucThanhToan, a.TenPhuongThucThanhToan);
            }
        }
        ...
        public PhuongThucThanhToan GetvaluaContro()
        {
            ...
            {
                MaPhuongThucThanhToan = txt_mapttt.Texts,
                TenPhuongThucThanhToan= txt_tenpttt.Texts
            };
        }
